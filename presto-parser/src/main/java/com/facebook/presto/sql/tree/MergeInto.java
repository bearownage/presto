...
public final class MergeInto extends Statement {

    private final QualifiedName target;
    private final Query query;
    private final Optional<List<Identifier>> columns;

    public MergeInto(QualifiedName target, Optional<List<Identifier>> columns, Query query) {
        this(Optional.empty(), columns, target, query);
    }

    private MergeInto(Optional<NodeLocation> location, Optional<List<Identifier>> columns, QualifiedName target, Query query) {
        super(location);
