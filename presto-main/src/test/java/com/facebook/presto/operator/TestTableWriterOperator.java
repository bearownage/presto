...
public class TestTableWriterOperator
{
            ...
            throws Exception
    {
        ...
        JavaAggregationFunctionImplementation longMaxFunction = functionAndTypeManager.getJavaAggregateFunctionImplementation(
        ...
        TableWriterOperator operator = (TableWriterOperator) createTableWriterOperator(
                ...
                new AggregationOperatorFactory(
                        ...
                        ImmutableList.of(generateAccumulatorFactory(longMaxFunction, ImmutableList.of(0), Optional.empty())),
                        true),
                outputTypes,
                session,
                taskMetadataContext,
